#!/bin/bash
# =================================================================
#   Setup da VM - Gerência de Configuração de Software (Univates)
...
REPO_URL="https://github.com/Alissa-T/task2_larissa.git"
...
if [ ! -f .env ]; then
  if [ -f .env.example ]; then
    ...
    echo -e "DB_HOST=homolog-db\nDB_PORT=5432\nDB_NAME=financeiro_db\nDB_USER=postgres\nDB_PASS=postgres\nPORT=3000\nSESSION_SECRET=segredo_univates_super_secreto_2026\n" > .env
