...
async function seed() {
    ...
    `,
		...
		const lancamentos = [
			["Salário mensal", "2026-03-01", 5500.0, "receita"],
			["Freelance - projeto web", "2026-03-05", 2800.0, "receita"],
			["Aluguel do apartamento", "2026-03-05", 1800.0, "despesa"],
			["Conta de energia", "2026-03-10", 245.5, "despesa"],
			["Supermercado", "2026-03-12", 687.3, "despesa"],
			["Venda de produto online", "2026-03-14", 450.0, "receita"],
			["Internet e telefone", "2026-03-15", 159.9, "despesa"],
			["Combustível", "2026-03-18", 320.0, "despesa"],
			["Rendimento investimentos", "2026-03-20", 185.75, "receita"],
			["Manutenção do carro", "2026-03-22", 530.0, "despesa"],
		];
